namespace BlazorDapperCodeGenerator.Data;
using System;
...
{
    public static readonly Dictionary<string, string> _dict = new()
    {
        {"bigint", "int"},
        {"binary", "Byte[]"},
        {"bit", "bool"},
    ...
    public static readonly Dictionary<string, string> _htmltypes = new()
            {
        {"byte","text" },
        {"byte[]","file" },
        {"int", "number"},
    ...
    public static readonly Dictionary<string, string> _dbtypes = new()
    {
        {"bigint", "Int64"},
        {"binary", "Binary"},
        {"bit", "Boolean"},
